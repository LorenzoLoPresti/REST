...
//		AnnotationConfigApplicationContext app = new AnnotationConfigApplicationContext(EdificioConfiguration.class);
//		Edificio e = (Edificio) app.getBean("nuovoEdificioCustom");
		
//		edificioService.inserisciEdificio(e);
		// leggo edificio dal db
//		Edificio edificioLetto = edificioService.cercaEdificioPerNome("Ciao Building");
